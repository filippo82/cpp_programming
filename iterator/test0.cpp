...
{
    // Hello
    std::cout << "Hello! This is a tutorial on constant interators." << std::endl;
    ...
    auto init_lambda = [coeff = coeff] (auto & elem) {elem = coeff;};
    std::for_each(vec0.begin(), vec0.end(), init_lambda);
